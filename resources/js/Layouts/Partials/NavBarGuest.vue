                ...
                <PopoverPanel focus class="absolute z-30 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                    <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                        <div class="pt-5 pb-6 px-5">
                            ...
                            <div class="mt-6">
                                <nav class="grid grid-cols-1 gap-7">
                                    <Link :href="route('HomePage')" class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50">
                                    ...
                                    <Link href="#" class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50">
                                        <div class="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-gradient-to-r from-sky-400 to-blue-600 text-white">
                        ...
                        <div class="py-6 px-5">
                            ...
                            <div v-else>
                                <div class="mt-6">
                                    <Link :href="route('login')" class="w-full flex items-center justify-center bg-gradient-to-r from-sky-400 to-blue-600 bg-origin-border px-4 py-2 border border-transparent rounded-md shadow-sm text-sm uppercase font-medium text-white hover:from-sky-700 hover:to-blue-700">Log in</Link>
